...
if [ -f /root/.ssh/inventre_github_deploy ]; then
  ...
  if git push --quiet git@github.com:Sunith0801/Inventre-Website.git --all 2>>"$LOGDIR/code-backup.log" && git push --quiet git@github.com:Sunith0801/Inventre-Website.git --tags 2>>"$LOGDIR/code-backup.log"; then
