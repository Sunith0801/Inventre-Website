...
- **Architecture**: `docs/architecture/Inventre-HLD-v1.3.pdf` (high-level) and `docs/architecture/Inventre-LLD-v1.3.pdf` (low-level); sources in `docs/architecture/design-docs/`. Superseded plans live in `docs/history/`.
...
| `docs/architecture/Inventre-HLD-v1.3.pdf`, `Inventre-LLD-v1.3.pdf` | Architecture (as built) + detailed design, with the rectification register |
