...
- **Governance**: `docs/governance/Inventre-Data-Protection-v1.1.pdf` (personal data inventory, DPDP Act 2023 gap assessment, action plan) and `docs/governance/Inventre-DR-BCP-v1.1.pdf` (recovery targets, roles, playbooks, drills).
