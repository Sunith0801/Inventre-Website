...
- **Architecture**: `docs/architecture/Inventre-HLD-v1.6.pdf` (high-level) and `docs/architecture/Inventre-LLD-v1.6.pdf` (low-level); sources in `docs/architecture/design-docs/`. Superseded plans live in `docs/history/`.
...
| `docs/architecture/Inventre-HLD-v1.6.pdf`, `Inventre-LLD-v1.6.pdf` | Architecture (as built) + detailed design, with the rectification register |
